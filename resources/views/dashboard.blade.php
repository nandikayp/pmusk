...
<div class="antialiased bg-gray-50 dark:bg-gray-900">
    <nav class="bg-white pt-5 border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
            <img
              ...
              alt="Flowbite Logo"
            />
            <span class="self-center text-blue-700 text-2xl font-poppins font-semibold whitespace-nowrap dark:text-white">ClassRoom</span>
          </a>
        ...
        <div class="flex items-center lg:order-2">
          ...
          >
            <div class="py-3 px-4">
              <span
                class="block text-sm font-semibold font-poppins  text-blue-700 dark:text-white"
                >{{ Auth::user()->name }}</span
              >
              <span
    ...
    <div class="p-4 mb-4 mt-5 text-sm text-slate-50 font-poppins font-light rounded-lg bg-blue-600 dark:bg-gray-800 dark:text-blue-400"
        role="alert">
